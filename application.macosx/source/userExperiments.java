...
public class userExperiments extends PApplet {
...
//right knee
//right foot
public void buildJointArray(int user, int userId)
{
...
public void addJoint(int userId, int jointName)
{
  PMatrix3D joint=new PMatrix3D();
...
public void keyPressed()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "userExperiments" };
    if (passedArgs != null) {
